...
class MyObjectFactory{
    ...
    static MyObject newChildClassObj() throws IOException {
        //使用ASM库生成子类
        ClassReader classReader = new ClassReader("com.zhangwei.javabase.common.MyObject");
        ...
        Class enhancedMyObjectClass = classLodaer.defineClassFromBytes("com.zhangwei.javabase.common.MyObject$EnhancedByASM",classWriter.toByteArray());
        try {
